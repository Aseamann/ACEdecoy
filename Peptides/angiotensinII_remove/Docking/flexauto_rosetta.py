...
def check_score_protein_relax():
    ...
    copyfile("output_files/relax/" + best_pdb + ".pdb", "input_files/protein_ensembles/" + best_pdb + ".pdb")
    return best_pdb
...
def main():
    ...
    global rosetta_dir
    rosetta_dir = "/opt/rosetta_src_2021.16.61629_bundle/"
